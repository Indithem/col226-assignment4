...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 18 "examples/example.mly"
                            ( _1 )
# 97 "examples/example.ml"
               : int))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : int) in
    Obj.repr(
# 21 "examples/example.mly"
                            ( _1 )
# 104 "examples/example.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'expr) in
    Obj.repr(
# 22 "examples/example.mly"
                              ( _2 )
# 111 "examples/example.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 23 "examples/example.mly"
                              ( _1 + _3 )
# 119 "examples/example.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 24 "examples/example.mly"
                              ( _1 - _3 )
# 127 "examples/example.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 25 "examples/example.mly"
                              ( _1 * _3 )
# 135 "examples/example.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 26 "examples/example.mly"
                              ( _1 / _3 )
# 143 "examples/example.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 27 "examples/example.mly"
                              ( - _2 )
# 150 "examples/example.ml"
               : 'expr))
(* Entry main *)
